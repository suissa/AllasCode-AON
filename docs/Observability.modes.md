# RFC-0004: Observability Modes & CrystalBox Specification

- **Specification**: Observability Modes & CrystalBox Protocol Extension
- **Status**: Standard / Stable
- **Version**: 1.0.0
- **Date**: 2026-09-14
- **Context**: Full Agent Stack Initiative
- **Pattern Type**: Observability Architecture & Interactive Runtime Protocol
...
- [x] **MODES-C1**: Suporte determinístico para seleção via cabeçalhos HTTP standard (`Accept`) e estendidos (`X-Crystal-Mode`).
- [x] **MODES-C2**: Respeito estrito aos códigos 102 Processing e 103 Early Hints.
- [x] **MODES-C3**: Isolamento e sanitização de dados sensíveis nas notificações para desenvolvedores.
